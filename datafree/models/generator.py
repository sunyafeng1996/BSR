...
class DCGAN_Generator(nn.Module):
    ...
    def clone(self):
        # clone = DCGAN_Generator(self.params[0], self.params[1], self.params[2], self.params[3])
        # clone.load_state_dict(self.state_dict())
